...
app_path="$skill_dir/assets/Bioinformatics Sandbox.app"
layout_script="$script_dir/layout-dmg.applescript"
output_path="${1:-$skill_dir/assets/Bioinformatics-Sandbox.dmg}"
volume_name="Bioinformatics Sandbox"
temporary_root="${TMPDIR:-/tmp}"
build_root="$(mktemp -d "${temporary_root%/}/bioinformatics-sandbox-dmg.XXXXXX")"
mount_point=""
...
read_write_dmg="$build_root/Bioinformatics-Sandbox-rw.dmg"
mkdir -p "$staging_dir"
cp -R "$app_path" "$staging_dir/Bioinformatics Sandbox.app"
