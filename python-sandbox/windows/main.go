...
func showSetupForm() (setupSelection, bool, error) {
	...
	cmd.Env = append(os.Environ(),
		"VSCODE_SANDBOX_APP_NAME="+appName,
		"VSCODE_SANDBOX_VERSION_LABEL="+versionPrompt,
		"VSCODE_SANDBOX_DEFAULT_VERSION="+defaultVersion,
		"VSCODE_SANDBOX_DEFAULT_PROJECT="+filepath.Join(home, "Desktop", sandboxSlug+"-project"),
		"VSCODE_SANDBOX_NEEDS_VERSION="+strconv.FormatBool(needsVersion),
...
function Add-Label($text, $y) {
  ...
  $label.Text = $text; $label.Location = New-Object Drawing.Point(18, $y); $label.Size = New-Object Drawing.Size(130, 23)
  $form.Controls.Add($label)
}
if ($needsVersion) {
  Add-Label $versionLabelText $top
  $version = New-Object Windows.Forms.TextBox
  $version.Text = $defaultVersion; $version.Location = New-Object Drawing.Point(155, $top); $version.Size = New-Object Drawing.Size(505, 23)
  $form.Controls.Add($version); $top += 38
}
Add-Label 'Agent' $top
$agent = New-Object Windows.Forms.ComboBox
$agent.DropDownStyle = 'DropDownList'; [void]$agent.Items.AddRange(@('codex', 'claude')); $agent.SelectedIndex = 0
$agent.Location = New-Object Drawing.Point(155, $top); $agent.Size = New-Object Drawing.Size(505, 23); $form.Controls.Add($agent); $top += 38
Add-Label 'Project folder' $top
$project = New-Object Windows.Forms.TextBox
$project.Text = $defaultProject; $project.Location = New-Object Drawing.Point(155, $top); $project.Size = New-Object Drawing.Size(415, 23); $form.Controls.Add($project)
$browse = New-Object Windows.Forms.Button
$browse.Text = 'Browse...'; $browse.Location = New-Object Drawing.Point(580, ($top - 1)); $browse.Size = New-Object Drawing.Size(80, 25)
$browse.Add_Click({ $picker = New-Object Windows.Forms.FolderBrowserDialog; if ($picker.ShowDialog() -eq 'OK') { $project.Text = $picker.SelectedPath } })
$form.Controls.Add($browse); $top += 42
$setup = New-Object Windows.Forms.Button
$setup.Text = 'Setup'; $setup.Location = New-Object Drawing.Point(495, $top); $setup.Size = New-Object Drawing.Size(80, 28); $setup.DialogResult = 'OK'
$cancel = New-Object Windows.Forms.Button
$cancel.Text = 'Cancel'; $cancel.Location = New-Object Drawing.Point(580, $top); $cancel.Size = New-Object Drawing.Size(80, 28); $cancel.DialogResult = 'Cancel'
$form.AcceptButton = $setup; $form.CancelButton = $cancel; $form.Controls.Add($setup); $form.Controls.Add($cancel)
if ($form.ShowDialog() -eq 'OK') {
  $selectedVersion = if ($needsVersion) { $version.Text.Trim() } else { '' }
  if (($needsVersion -and $selectedVersion -eq '') -or $project.Text.Trim() -eq '') { [Windows.Forms.MessageBox]::Show('All fields are required.', $appName, 'OK', 'Error'); exit 2 }
  [IO.File]::WriteAllLines($resultPath, @($selectedVersion, $agent.SelectedItem.ToString(), $project.Text.Trim()), (New-Object Text.UTF8Encoding($false)))
}
`
